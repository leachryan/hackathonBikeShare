        ...
        <!--<asp:Button ID="bikeDataButton" runat="server" Text="Click to refresh" /> OnClick="bikeDataButton_Click" -->
            <table>
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" Font-Underline="true">Station Address</asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel1" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel2" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel3" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel4" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel5" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel6" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel7" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel8" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel9" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel10" NavigateUrl=""></asp:HyperLink></td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" ID="addrLabel11" NavigateUrl=""></asp:HyperLink></td>
