...
namespace bikeShareWebApp
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //testBox.Text = Convert.ToString(stationResults.Count());
            foreach(Station stationObj in stationResults)
            {
                testingString += stationObj.name;
            }
            testBox.Text = testingString;
            ...
            string bikeTestingString = "";
            //testBox.Text = Convert.ToString(stationResults.Count());
            foreach (Bike bikeObj in bikeResults)
            {
                bikeTestingString += bikeObj.num_bikes_available;
            }
            testBox.Text = bikeTestingString;
